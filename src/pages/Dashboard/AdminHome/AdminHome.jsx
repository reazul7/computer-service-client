...
export default function AdminHome() {
    ...
    // Transform chartData to include capitalized category names
    ...
    const pieChartData = transformedChartData?.map(data => {
        return {
            name: data.category,
            value: data.revenue,
        };
    ...
    return (
        <div>
            ...
            <div className="flex">
                <div className="w-1/2">
                    <BarChart width={500} height={300} data={transformedChartData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
